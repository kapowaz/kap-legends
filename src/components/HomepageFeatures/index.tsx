...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        Manufactured using Keyreative’s state of the art hybrid doubleshot process which produces
        sharp and durable legends, supporting dyesublimated multicolor legends.
      </>
    ),
  },
  {
